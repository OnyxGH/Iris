...
public sealed class ProjectTrustStore(string agentDir)
{
    ...
    /// <summary>
    /// True when cwd has trust-requiring entries under cwd/.pisharp or a .agents/skills directory in cwd or an ancestor
    ...
    private void WriteTrustFile(Dictionary<string, bool?> data)
    {
        ...
        File.WriteAllText(_trustPath, PiSharp.Ai.Json.PiJson.SerializeIndentedTwoSpaces(sorted) + "\n");
    }
