...
/// own releases; PiSharp has no release endpoint yet, so the URL comes from PISHARP_LATEST_VERSION_URL (same JSON shape:
/// {"version": "...", "packageName"?: "...", "note"?: "..."}) and checks are skipped when it is unset.
/// </summary>
public static class VersionCheck
{
    public const string LatestVersionUrlEnv = "PISHARP_LATEST_VERSION_URL";
