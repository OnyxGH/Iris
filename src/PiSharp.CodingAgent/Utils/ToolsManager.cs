...
public static class ToolsManager
{
    ...
    private static readonly HttpClient NoRedirectClient = new(new SocketsHttpHandler { AllowAutoRedirect = false, UseProxy = true, Proxy = PiSharp.Ai.Utils.EnvHttpProxy.Instance });
