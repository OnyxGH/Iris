...
namespace PiSharp.CodingAgent.Extensions.Llama;

/// <summary>
/// Built-in llama.cpp provider: dynamic catalog from a router-mode llama-server. Port of extensions/llama/provider.ts.
/// pi registers it through its hidden built-in extension; PiSharp registers it directly on each model runtime.
/// </summary>
