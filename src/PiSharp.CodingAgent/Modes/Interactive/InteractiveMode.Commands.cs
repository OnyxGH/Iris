...
public sealed partial class InteractiveMode
{
        ...
        ShowSelector(done =>
        {
            ...
            var callbacks = new SettingsCallbacks
            {
                ...
                OnTuiModeChange = mode =>
                {
                    ...
                    if (mode != "regular") ShowStatus("Fullscreen TUI mode is not supported in PiSharp");
                },
    ...
    private void HandleExportCommand(string text)
    {
        ...
        try
        {
            ...
            {
                ShowError("Failed to export session: HTML export is not available in PiSharp yet. Use /export <file.jsonl>.");
            }
        }
        catch (Exception ex)
        {
    ...
    private void HandleShareCommand() => ShowError("/share is not available in PiSharp yet.");
